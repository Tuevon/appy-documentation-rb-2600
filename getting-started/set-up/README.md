...
The [Application](application-forms.md) forms give you control over who you approve for certain things on your server. This can be anything from staff jobs, to game members, various discord roles or anything else that just fits into your community.

<figure><img src="../../.gitbook/assets/Application exampel.png" alt=""><figcaption></figcaption></figure>
{% endtab %}

{% tab title="Application Panels" %}
With an [Application Panel](application-panels.md) you can show which open application forms you have, this provides an easier overview for your members.
